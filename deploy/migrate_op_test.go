...
case "$class" in
  core) printf '80:f' >"$state_dir/core"; touch "$state_dir/core-migrated" ;;
  bootstrap) printf '24:f' >"$state_dir/sdpivot"; touch "$state_dir/bootstrap-migrated" ;;
  *) exit 8 ;;
esac
`)
	...
	tests := []migrationScenario{
		...
		},
		{
			...
			wantCalls: []string{
				...
				"psql:sdp-exists", "psql:sdp-state", "psql:sdp-exists", "psql:sdp-state",
				"psql:sdp-fingerprint", "psql:sdp-v13-schema", "psql:sdp-v13-account", "psql:sdp-latest",
			},
		},
		{
			name:      "dedicated sdpivot ledger at v12",
			coreState: "80:f", sdpivotState: "12:f", publicTables: "1",
			...
			wantCalls: []string{
				...
				"psql:sdp-fingerprint", "migrate:bootstrap", "psql:sdp-exists", "psql:sdp-state",
				"psql:sdp-fingerprint", "psql:sdp-v13-schema", "psql:sdp-v13-account", "psql:sdp-latest",
			},
		},
		{
			name:      "dedicated sdpivot ledger at v13",
			coreState: "80:f", sdpivotState: "13:f", publicTables: "1",
			coreFingerprint: "complete", sdpFingerprint: "complete", wantSuccess: true,
			wantCalls: []string{
				"psql:core-exists", "psql:core-state", "psql:core-audit-m44", "psql:core-exists", "psql:core-state", "psql:core-audit-m44",
		...
		},
		{
			...
			coreState: "80:f", sdpivotState: "24:f", publicTables: "1",
			coreFingerprint: "complete", sdpFingerprint: "complete", wantSuccess: true,
			wantCalls: []string{
				"psql:core-exists", "psql:core-state", "psql:core-audit-m44", "psql:core-exists", "psql:core-state", "psql:core-audit-m44",
				"psql:sdp-exists", "psql:sdp-state",
...
func TestMigrationStateMachineFailsClosedForUnsafeStates(t *testing.T) {
	tests := []migrationScenario{
		...
		{name: "sdpivot dirty", coreState: "80:f", sdpivotState: "12:t", coreFingerprint: "complete", sdpFingerprint: "complete", wantCalls: []string{}},
		...
		{name: "partial table set", coreState: "80:f", sdpivotState: "absent", coreFingerprint: "complete", sdpFingerprint: "partial"},
		{name: "critical column missing", coreState: "80:f", sdpivotState: "12:f", coreFingerprint: "complete", sdpFingerprint: "partial"},
		{name: "function missing or mismatched", coreState: "80:f", sdpivotState: "12:f", coreFingerprint: "complete", sdpFingerprint: "partial"},
		{name: "target rls missing", coreState: "80:f", sdpivotState: "12:f", coreFingerprint: "complete", sdpFingerprint: "partial"},
		{name: "document chunks not force or lacks dual tenant policy", coreState: "80:f", sdpivotState: "12:f", coreFingerprint: "complete", sdpFingerprint: "partial"},
		{name: "future sdpivot version", coreState: "80:f", sdpivotState: "25:f", coreFingerprint: "complete", sdpFingerprint: "complete", wantCalls: []string{}},
		{name: "future sdpivot version before core migration", coreState: "absent", sdpivotState: "25:f", publicTables: "0", coreFingerprint: "complete", sdpFingerprint: "empty", wantCalls: []string{}},
		{name: "v13 empty state table", coreState: "80:f", sdpivotState: "13:f", coreFingerprint: "complete", sdpFingerprint: "complete", sdpV13Schema: "partial"},
		{name: "v13 wrong state table structure", coreState: "80:f", sdpivotState: "13:f", coreFingerprint: "complete", sdpFingerprint: "complete", sdpV13Schema: "partial"},
		{name: "v13 known legacy hash still active", coreState: "80:f", sdpivotState: "13:f", coreFingerprint: "complete", sdpFingerprint: "complete", sdpV13Account: "partial"},
		{name: "latest policy missing", coreState: "80:f", sdpivotState: "24:f", coreFingerprint: "complete", sdpFingerprint: "complete", sdpLatest: "partial"},
		{name: "latest policy missing with check", coreState: "80:f", sdpivotState: "24:f", coreFingerprint: "complete", sdpFingerprint: "complete", sdpLatest: "partial"},
		{name: "latest extra permissive policy", coreState: "80:f", sdpivotState: "24:f", coreFingerprint: "complete", sdpFingerprint: "complete", sdpLatest: "partial"},
	}
...
func TestMigrationStateMachineStopsImmediatelyWhenCommandFails(t *testing.T) {
	tests := []migrationScenario{
		...
		{name: "fingerprint inspection fails", coreState: "80:f", sdpivotState: "absent", sdpFingerprint: "empty", failAt: "psql:sdp-fingerprint", wantCalls: []string{"psql:core-exists", "psql:core-state", "psql:core-audit-m44", "psql:core-exists", "psql:core-state", "psql:core-audit-m44", "psql:sdp-exists", "psql:sdp-fingerprint"}},
		{name: "bootstrap migration fails", coreState: "80:f", sdpivotState: "absent", sdpFingerprint: "empty", failAt: "migrate:bootstrap", wantCalls: []string{"psql:core-exists", "psql:core-state", "psql:core-audit-m44", "psql:core-exists", "psql:core-state", "psql:core-audit-m44", "psql:sdp-exists", "psql:sdp-fingerprint", "migrate:bootstrap"}},
		{name: "security migration fails", coreState: "80:f", sdpivotState: "12:f", sdpFingerprint: "complete", failAt: "migrate:bootstrap", wantCalls: []string{"psql:core-exists", "psql:core-state", "psql:core-audit-m44", "psql:core-exists", "psql:core-state", "psql:core-audit-m44", "psql:sdp-exists", "psql:sdp-state", "psql:sdp-fingerprint", "migrate:bootstrap"}},
	}
