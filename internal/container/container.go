...
func BuildContainer(container *dig.Container) *dig.Container {
	...
	must(container.Provide(repository.NewDocumentTagRepository))
	...
	must(container.Provide(service.NewAutoTagGenerationService, dig.Name("autoTagGeneration")))
	...
	must(container.Provide(handler.NewSDPivotAdminHandler))
	must(container.Provide(handler.NewSDPivotTagAutoHandler))
	must(container.Provide(handler.NewSDPivotTagDimensionHandler))
	must(container.Provide(handler.NewSDPivotTagFeedbackHandler))
