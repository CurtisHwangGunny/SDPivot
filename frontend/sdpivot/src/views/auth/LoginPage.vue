...
.login-container {
  ...
  background:
    ...
    linear-gradient(135deg, var(--sdp-bg) 0%, color-mix(in srgb, var(--sdp-surface-soft) 88%, var(--sdp-bg)) 100%);
}
...
.hero-points li {
  padding-left: 18px;
  position: relative;
  color: color-mix(in srgb, var(--sdp-sidebar-text) 90%, transparent);
}
