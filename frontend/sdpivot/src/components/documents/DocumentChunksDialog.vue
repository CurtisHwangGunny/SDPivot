...
.chunks-summary { margin-bottom: 14px; padding: 12px 14px; border-radius: 12px; background: var(--sdp-brand-soft); color: var(--sdp-brand-deep); font-size: 12px; line-height: 1.6; }
...
.chunk-card { border-radius: 12px; background: var(--td-bg-color-container); box-shadow: var(--sdp-shadow-sm); }
