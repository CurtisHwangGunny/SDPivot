...
.muted-panel {
  background: linear-gradient(180deg, color-mix(in srgb, var(--surface-elevated) 98%, transparent), color-mix(in srgb, var(--sdp-surface-soft) 94%, transparent));
}
.panel-head {
  display: flex;
...
.light-preview {
  background: linear-gradient(180deg, color-mix(in srgb, var(--sdp-surface-soft) 92%, white) 0%, color-mix(in srgb, var(--surface-elevated) 96%, white) 100%);
}
.dark-preview {
