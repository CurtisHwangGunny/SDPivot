export default {
  ...
  knowledgeBase: {
    ...
    classificationFilter: 'Фильтр классификации',
    classificationFilterPlaceholder: 'Теги классификации',
    classificationTags: 'Классификация',
    lowConfidenceWarning: 'Обнаружена классификация с LOW уверенностью. Проверьте теги ниже 70%.',
...
/example\.(net|org)/`,
  ...
  modelSettings: {
    ...
    modelConfigs: {
      navLabel: 'Модели платформы',
      title: 'Конфигурации моделей платформы',
      description: 'Управление общими upstream-сервисами моделей. API-ключи шифруются и не возвращаются.',
      add: 'Добавить модель',
      addFirst: 'Добавить первую модель',
      empty: 'Конфигурации моделей платформы отсутствуют',
      current: 'Текущая конфигурация',
      noEndpoint: 'Пользовательский endpoint не задан',
      name: 'Название',
      namePlaceholder: 'Например: Production OpenAI',
      provider: 'Провайдер',
      providerPlaceholder: 'Например: openai',
      endpoint: 'API endpoint',
      apiKey: 'API-ключ',
      apiKeyHelp: 'Ключ шифруется сервером перед сохранением.',
      apiKeyEditHelp: 'Ключ уже задан. Оставьте поле пустым, чтобы сохранить его.',
      apiKeyPlaceholder: 'Оставьте пустым, чтобы не задавать или сохранить текущий ключ',
      temperature: 'Температура',
      maxTokens: 'Макс. токенов',
      topP: 'Top P',
      configured: 'Настроен',
      notConfigured: 'Не настроен',
      createTitle: 'Добавить модель платформы',
      editTitle: 'Изменить модель платформы',
      required: 'Название и провайдер обязательны',
      invalidEndpoint: 'Введите корректный URL API endpoint',
      loadFailed: 'Не удалось загрузить модели платформы',
      saveSuccess: 'Модель платформы сохранена',
      saveFailed: 'Не удалось сохранить модель платформы',
      deleteSuccess: 'Модель платформы удалена',
      deleteFailed: 'Не удалось удалить модель платформы',
      deleteConfirm: 'Удалить модель «{name}»?',
    },
  },
  ollamaSettings: {
  ...
  input: {
    ...
    modelEmptyAdmin: 'Модель чата не настроена. Добавьте её в настройках моделей перед началом диалога.',
    modelEmptyMember: 'Модель чата не настроена. Попросите администратора пространства добавить её в настройках моделей.',
    configureModels: 'Открыть настройки моделей',
