export default {
  ...
  knowledgeBase: {
    ...
    classificationFilterPlaceholder: 'Classification tags',
    classificationTags: 'Classification',
    lowConfidenceWarning: 'LOW confidence classification detected. Review tags below 70% before relying on them.',
  ...
  input: {
    ...
    modelEmptyAdmin: 'No chat model is configured. Add one in Model Settings before starting a conversation.',
    modelEmptyMember: 'No chat model is configured. Ask a tenant administrator to add one in Model Settings.',
    configureModels: 'Open Model Settings',
...
\
  ...
  model: {
    ...
    modelConfigs: {
      navLabel: 'Platform Models',
      title: 'Platform Model Configurations',
      description: 'Manage platform-wide upstream model services. API keys are encrypted and never returned.',
      add: 'Add Model',
      addFirst: 'Add the first model',
      empty: 'No platform model configurations',
      current: 'Current configuration',
      noEndpoint: 'No custom endpoint configured',
      name: 'Name',
      namePlaceholder: 'For example: Production OpenAI',
      provider: 'Provider',
      providerPlaceholder: 'For example: openai',
      endpoint: 'API endpoint',
      apiKey: 'API key',
      apiKeyHelp: 'The key is encrypted by the server before storage.',
      apiKeyEditHelp: 'A key is configured. Leave blank to keep it unchanged.',
      apiKeyPlaceholder: 'Leave blank to omit or preserve the existing key',
      temperature: 'Temperature',
      maxTokens: 'Max tokens',
      topP: 'Top P',
      configured: 'Configured',
      notConfigured: 'Not configured',
      createTitle: 'Add Platform Model',
      editTitle: 'Edit Platform Model',
      required: 'Name and provider are required',
      invalidEndpoint: 'Enter a valid API endpoint URL',
      loadFailed: 'Failed to load platform models',
      saveSuccess: 'Platform model saved',
      saveFailed: 'Failed to save platform model',
      deleteSuccess: 'Platform model deleted',
      deleteFailed: 'Failed to delete platform model',
