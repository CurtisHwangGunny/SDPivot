export default {
  ...
  knowledgeBase: {
    ...
    classificationFilter: '분류 필터',
    classificationFilterPlaceholder: '분류 태그',
    classificationTags: '분류',
    lowConfidenceWarning: 'LOW 신뢰도 분류가 감지되었습니다. 70% 미만 태그를 검토하세요.',
  ...
  system: {
    ...
    modelConfigs: {
      navLabel: "플랫폼 모델",
      title: "플랫폼 모델 설정",
      description: "플랫폼 전역 업스트림 모델 서비스를 관리합니다. API 키는 암호화되어 저장되며 다시 표시되지 않습니다.",
      add: "모델 추가",
      addFirst: "첫 모델 추가",
      empty: "플랫폼 모델 설정이 없습니다",
      current: "현재 설정",
      noEndpoint: "사용자 지정 엔드포인트 없음",
      name: "이름",
      namePlaceholder: "예: Production OpenAI",
      provider: "제공자",
      providerPlaceholder: "예: openai",
      endpoint: "API 엔드포인트",
      apiKey: "API 키",
      apiKeyHelp: "키는 서버에서 암호화한 후 저장됩니다.",
      apiKeyEditHelp: "키가 설정되어 있습니다. 비워 두면 기존 키를 유지합니다.",
      apiKeyPlaceholder: "설정하지 않거나 기존 키를 유지하려면 비워 두세요",
      temperature: "온도",
      maxTokens: "최대 토큰 수",
      topP: "Top P",
      configured: "설정됨",
      notConfigured: "설정 안 됨",
      createTitle: "플랫폼 모델 추가",
      editTitle: "플랫폼 모델 편집",
      required: "이름과 제공자는 필수입니다",
      invalidEndpoint: "유효한 API 엔드포인트 URL을 입력하세요",
      loadFailed: "플랫폼 모델을 불러오지 못했습니다",
      saveSuccess: "플랫폼 모델을 저장했습니다",
      saveFailed: "플랫폼 모델 저장 실패",
      deleteSuccess: "플랫폼 모델을 삭제했습니다",
      deleteFailed: "플랫폼 모델 삭제 실패",
      deleteConfirm: "“{name}” 모델을 삭제하시겠습니까?",
    },
  },
  mcp: {
    testResult: {
  ...
  input: {
    ...
    modelEmptyAdmin: "구성된 채팅 모델이 없습니다. 대화를 시작하기 전에 모델 설정에서 모델을 추가하세요.",
    modelEmptyMember: "구성된 채팅 모델이 없습니다. 테넌트 관리자에게 모델 설정에서 모델을 추가하도록 요청하세요.",
    configureModels: "모델 설정 열기",
