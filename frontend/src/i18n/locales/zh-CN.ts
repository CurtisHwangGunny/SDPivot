export default {
  ...
  knowledgeBase: {
    ...
    classificationFilterPlaceholder: "分类标签",
    classificationTags: "智能分类",
    lowConfidenceWarning: "检测到 LOW 置信度分类，请复核低于 70% 的标签后再使用。",
  ...
  system: {
    ...
    modelConfigs: {
      navLabel: "平台模型",
      title: "平台模型配置",
      description: "管理平台级上游模型服务。API Key 加密保存且不会回显。",
      add: "添加模型",
      addFirst: "添加第一个模型",
      empty: "暂无平台模型配置",
      current: "当前配置",
      noEndpoint: "未配置自定义端点",
      name: "名称",
      namePlaceholder: "例如：生产 OpenAI",
      provider: "服务商",
      providerPlaceholder: "例如：openai",
      endpoint: "API 端点",
      apiKey: "API Key",
      apiKeyHelp: "密钥将由服务端加密保存。",
      apiKeyEditHelp: "已配置密钥；留空可保留现有密钥。",
      apiKeyPlaceholder: "留空表示不设置或保留现有密钥",
      temperature: "温度",
      maxTokens: "最大令牌数",
      topP: "Top P",
      configured: "已配置",
      ...
      editTitle: "编辑平台模型",
      required: "名称和服务商不能为空",
      invalidEndpoint: "请输入有效的 API 端点 URL",
      loadFailed: "加载平台模型失败",
      saveSuccess: "平台模型已保存",
      saveFailed: "保存平台模型失败",
      deleteSuccess: "平台模型已删除",
      deleteFailed: "删除平台模型失败",
  ...
  input: {
    ...
    remote: "远程",
    noModel: "暂无可用模型",
    modelEmptyAdmin: "尚未配置对话模型。请先前往模型设置添加模型，再开始对话。",
    modelEmptyMember: "尚未配置对话模型。请联系租户管理员前往模型设置添加模型。",
